...
connection string as the app itself.
"""
import asyncio
...
# Side-effect imports: register ORM models on Base.metadata
from app.models import user, api_key, model_catalog, wallet, transaction, usage_log  # noqa: F401
